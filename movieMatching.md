...
`_misspelt` ([tmdblookup.py:538](medialib/lib/tmdblookup.py:538)) reads a folder
...
`_last_segment` ([titlematch.py:1163](medialib/lib/titlematch.py:1163)) already
...
`MIN_TYPO_LENGTH = 6` ([titlematch.py:806](medialib/lib/titlematch.py:806)) and
